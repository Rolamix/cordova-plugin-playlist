...
export declare class RmxAudioPlayer {
  ...
  changeAudioSessionCategory: (
    successCallbacl: SuccessCallback,
    errorCallback: ErrorCallback
  ) => void;
  /**
  ...
  setPlaylistItems: (
    ...
    errorCallback: ErrorCallback,
    items: AudioTrack[],
    options?: PlaylistItemOptions | undefined
  ) => void;
  /**
  ...
  setOutputAudioPortToSpeaker: (
    successCallback: SuccessCallback,
    errorCallback: ErrorCallback
  ) => void;
  setOutputAudioPortToReceiver: (
    successCallback: SuccessCallback,
    errorCallback: ErrorCallback
  ) => void;
  /**
